...
// It has been converted from the React file format to a standard JS variable.
...
const data = {
  en: {
    ...
    'hard-fm': [
      {
        question: 'Scopes of work, any current service levels, and baseline spend per values, per category, and any back-up documentation e.g., financial reports, contracts, job descriptions, PO’s, invoice copies, work order histories, service tickets and asset lists for the previous 12 months.',
        comment: null,
      },
      {
      ...
      {
        question: 'Provide a list of all current planned maintenance tasks (PPM) & frequency for all assets to be maintained.',
        comment: null,
      },
      {
        question: 'List of contractors / subcontractors with their contact information, scope of work and contract end date.',
        comment: 'Vendor list of subcontractors and contracts',
      },
      {
        question: 'What is the current process for sourcing subcontractors?',
        comment: null,
      },
      {
        question: 'Provide an overview of the number of helpdesk calls last year by service line.',
        comment: null,
      },
      {
        question: 'Is there a plan for any major changes during the next year that would impact the services (e.g. renovation, new construction, etc.)?',
        comment: null,
      },
      {
    ...
    'catering': [
      ...
      {
        question: 'Is there any food safety certification (e.g. HACCP)?',
        comment: null,
      },
      {
        question: 'Is there a plan to take over staff? (TUPE in European Countries)?',
      ...
      {
        question: 'VENDING: • Leasing ? If yes : • Leasing amount per month ? • Contract end date ? • Is it a full service leasing?',
        comment: 'Leasing amount per month? ',
      },
    ],
    'uniforms': [
      {
    ...
    'security-system': [
      {
        question: 'In the eyes of the client, what is the ASSET or MATERIAL with the BIGGEST RISK?',
        comment: null,
      },
      {
        question: 'What do you think is the MAIN FUNCTION OF THE SECURITY TEAM? (Access control, occupant service, deterrence, Health & Safety)?',
        comment: null,
      },
      {
        question: 'In addition to your security team, what other MEASURES ARE BEING IMPLEMENTED TO SECURE YOUR PREMISES? (use the free space to confirm who is responsible today for each piece of equipment - GE or Equans)',
        comment: '□ Access badges: □ Video surveillance: □ Control procedures: □ X-ray machines: □ Intruder Alarm: □ Parking surveillance: □ Fingerprint scanner: □ Access/Door Control: □ Rounds Management Software: □ Electronic Security: □ Fire alarm / Others: □ Integrated Systems / Building Management System (BMS): □ Others:',
      },
      {
        question: 'Are there HIGH-RISK AREAS / Is it a site for the control of major accident hazards?',
        comment: '□ Hazardous substances □ Sensitive processes □ Others',
      },
      {
        question: 'Is the perimeter of the site OPEN OR CLOSED / FENCED?',
        comment: '□ Open □ Closed',
      },
      {
        question: 'If it is fenced, what TYPE OF FENCE AND GATES do you have?',
        comment: 'Fence Type: □ Wire Mesh □ Welded Mesh □ Palisade Door Type:',
      },
      {
        question: 'What time are the VEHICLE BARRIERS closed? Type of vehicle barrier (steel, manual, electronic, vehicle with induction loop, barrier with single arm...)',
        comment: null,
      },
      {
        question: 'Are there PEDESTRIAN EXITS? How many?',
        comment: null,
      },
      {
        question: 'What INCIDENTS have taken place over the last 2 years on the site (example: theft, intrusion)?',
        comment: null,
      },
      {
        question: 'Detail the SOW-SLA: - Option 1: Complete the SOW/SLA tab (with existing tasks and frequencies) - Option 2: Detail the SOW-SLA in the box below',
        comment: null,
      },
      {
        question: 'Is the security managed by a single contractor or are there several? What is the name of the subcontractor(s)?',
        comment: null,
      },
      {
        question: 'SOW-SLA: Is there a need for dog patrols?',
        comment: null,
      },
      {
        question: 'SOW-SLA: What about the security of the building\'s roof?',
        comment: null,
      },
      {
        question: 'SOW-SLA: Are there specific security requirements for a specific date or time of the year (e.g. holidays)?',
        comment: null,
      },
      {
        question: 'SOW-SLA: Are there specific security requirements for special events? (e.g. concerts, company parties)',
        comment: null,
      },
      {
        question: 'KEY MANAGEMENT: • Role of security guards: e.g., total number of keys; Do they have the keys only for certain services?',
        comment: null,
      },
      {
        question: 'ROUND • Daily round / schedules / duration / maximum time between 2 rounds • Number of rounds',
        comment: null,
      },
      {
        question: 'ALARMS • Types of alarms? • Number of alarms on site',
        comment: null,
      },
      {
        question: 'EMERGENCY AND INCIDENT MANAGEMENT • Alarm processing time • Incident management level',
        comment: null,
      },
      {
        question: 'EQUIPMENT AND MATERIALS • List of equipment and materials • Who buys them / who owns them / who uses them • Brand of the equipment(s) - Who manages the maintenance?',
        comment: null,
      },
      {
        question: 'DELIVERY MANAGEMENT • Role of security (what should they control? Associated administrative tasks?) • Average number of deliveries per day',
        comment: null,
      },
      {
        question: 'Do the conventional mechanisms for the transfer of personnel apply in this case? (Bill 7 in Ontario)',
        comment: '□ YES □ NO If so, to whom does it apply?',
      },
      {
        question: 'NUMBER OF INTERVENTIONS: Indicate the number of DAYS PER WEEK that services will be performed (for example, 5, 6 or 7)',
        comment: null,
      },
      {
        question: 'Describe the ORGANIZATION IN PLACE (Organizational Chart & Management Structure)',
        comment: null,
      },
      {
        question: 'NUMBER OF HOURS WORKED PER FUNCTION (Manager, Supervisor, Agent;...)',
        comment: null,
      },
      {
        question: 'Confirm the NUMBER and DURATION of the rounds (e.g., 8 or 12 hours)',
        comment: '□ day: □ Night: □ Weekend: □ Other:',
      },
      {
        question: 'Are there any SPECIFIC BONUSES for the security team?',
        comment: null,
      },
      {
        question: 'QUALIFICATIONS: Do employees need to have specific training/qualifications?',
        comment: '□ YES □ NO If so, to whom does it apply?',
      },
      {
        question: 'CUSTOMER EXPECTATIONS: Does your current subcontractor have any best practices that you appreciate? Could improvements be made?',
        comment: null,
      },
    ],
    'waste-management': [
      ...
      {
        question: 'TYPE AND QUANTITY OF WASTE 1. Specify the different types of waste to be managed and their volume (L or m3) or weight (kg or tonne) of each type of waste per day / month / year All comers, DIB Cardboard Paper Plastics (specify which family of plastic: PS, PET, HDPE...) Biowaste Confidential waste E-waste Hazardous waste (with waste code) ... 2. Has the customer planned for any changes that may impact the volume of waste produced (e.g. increase or decrease in the population on site, change in site activity, expansion, other)?',
        comment: 'YES   NO      Qty Unit [  ]     [  ] [  ]     [  ] [  ]     [  ] [  ]     [  ] [  ]     [  ] [  ]     [  ] [  ]     [  ] [  ]     [  ] 2. [ ] YES [ ] NO',
      },
      {
        question: 'WASTE SORTING 1. Is waste sorting carried out? What waste is sorted? 2. What unsorted waste could be sorted? Example: cups, cans, batteries, toners, electrical waste, fluorescent tubes, food cuts, cardboard, paper, furniture, packaging? 4. Is there a buyback of waste? If so, to whom is the corresponding income paid?',
        comment: '1. 2. [ ] YES / [ ] NO If so, specify: 3. [ ] YES / [ ] NO If so, to whom: ',
      },
      {
        question: 'WASTE STORAGE AREA 1. Are there specific waste storage areas? 2. If so, are they centralized or decentralized? Are they easy to access and well equipped? 3. Is there a compactor, shredder, baler on site? Are they the property of the client or the contractor? If so, specify their cost, volume, supplier, waste concerned?',
        comment: '1. [ ] YES / [ ] NO 2. [ ] YES / [ ] NO description: 3. [ ] YES / [ ] NO description: ',
      },
      {
        question: 'WASTE DISPOSAL 1. Who is responsible for waste disposal? Client or Contractor? 2. Indicate the disposal frequency for each type of waste (e.g., daily, weekly, monthly, on call). 3. Indicate the name of the waste disposal providers.',
        comment: '1. [ ] CLIENT / [ ] CONTRACTOR 2. 3. ',
      },
      {
        question: 'WASTE EQUIPMENT 1. Is there any specific waste management equipment on site (e.g. skips, shredder, compactor, baler, etc.). If so, specify their cost, volume, supplier, waste concerned 3. General condition of the large equipment (specify for each type of equipment)? Who is responsible for its maintenance?',
        comment: '1. [ ] YES [ ] NO description: [ ] New [ ] Good [ ] Medium [ ] Poor - 2. [ ] YES [ ] NO description: 3. [ ] New [ ] Good [ ] Average [ ] Poor -',
      },
      {
        question: 'TRACEABILITY TRACKING REPORTING 1.Is the waste register the responsibility of Equans ? 2.In the case of hazardous waste management, are the BSDs the responsibility of Equans ? 3. Other requirements in terms of annual declaration or traceability elements for Equans ?',
        comment: '1.[ ] YES / [ ] NO 2.[ ] YES / [ ] NO 3.',
      },
      {
        question: 'Does the contractual principle of personnel transfer apply in this case? (Bill 7 in Ontario)',
        comment: '□ YES □ NO If so, to whom does it apply?',
      },
      {
        question: 'Describe the ORGANIZATION IN PLACE (number of team leaders, number of full-time/part-time employees, teams, work schedules, fixed assignment to the department or sharing with other departments, etc.). ',
        comment: null,
      },
      {
        question: 'QUALIFICATIONS: Do employees need to have specific training/qualifications: CACES permit, hazardous waste training, ADR transport,…',
        comment: '□ YES □ NO If yes, specify',
      },
      {
        question: 'Workwear 1. Is there a need for work clothes? 2. If so, are they provided by the customer?',
        comment: '1.[ ] YES / [ ] NO 2.[ ] YES / [ ] NO 3.',
      },
      {
        question: 'CUSTOMER EXPECTATIONS: Does your current subcontractor have any best practices that you appreciate? Are there any improvements that could be made?',
        comment: null,
      },
    ],
    'fuel-system': [
    ...
    'grounds-eng': [
      ...
      {
        question: 'ACCES • Is the size of the machines used limited due to access?',
        comment: ' [ ] YES [ ] NO If yes, please specify',
      },
      {
        question: 'HOURS OF INTERVENTION • Specify the possible days and hours of intervention',
        comment: null,
      },
      {
        question: 'EQUIPMENT • Who owns the equipment? • Who is responsible for equipment maintenance? • Is electrical equipment recommended, mandatory? • Is there automatic watering? ',
      ...
      },
      {
        ...
        comment: '1) [ ] YES [ ] NO 2) [ ] YES [ ] NO - List of pesticides used on site - Are there any local restrictions on the use of pesticides?',
      },
      {
      ...
      {
        question: 'CUSTOMER EXPECTATIONS: Are there any best practices you like with your current contractor? Are there any improvements that could be made?',
        comment: null,
      },
    ],
    'snow-removal': [
    ...
    'fm-equipment-leasing': [
      {
        question: 'List of equipement ( Foklift truck, pallet truck, motorized trolleys, photocopiers, floor cleaners, )',
        comment: null
      },
      {
        question: 'Duration of leasing,',
        comment: null
      },
      {
        question: 'Who is reponsable for the maintenance,',
        comment: null
      },
      {
        question: 'What\'S the budget of maintenance,',
        comment: null
      },
      {
        question: 'Copy of the latest invoices,',
        comment: null
      }
    ]
  },
  fr: {
    ...
    'hard-fm': [
      {
        question: 'Portée des travaux, niveaux de service actuels et dépenses de référence par valeurs, par catégorie, et toute documentation de sauvegarde, par exemple rapports financiers, contrats, descriptions de poste, bons de commande, copies de factures, historiques des bons de travail, tickets de service et listes d’actifs pour les 12 derniers mois.',
        comment: null,
      },
      {
      ...
      },
      {
        ...
        comment: 'référez-vous au SOW-SLA',
      },
      {
      ...
      {
        question: 'Fournir une liste de toutes les tâches de maintenance prévues (PPM) & la fréquence pour tous les actifs à entretenir.',
        comment: null,
      },
      {
        question: 'Liste des entrepreneurs / sous-traitants avec leurs coordonnées, leur champ de travail et la date de fin de leur contrat.',
        comment: 'Liste des fournisseurs de sous-traitants et des contrats',
      },
      {
        question: 'Quel est le processus actuel pour l’approvisionnement des sous-traitants ?',
        comment: null,
      },
      {
        question: 'Fournir un aperçu du nombre d’appels d’assistance l’année dernière par ligne de service.',
        comment: null,
      },
      {
        question: 'Y a-t-il un plan pour des changements majeurs au cours de l’année prochaine qui auraient un impact sur les services (par exemple, rénovation, nouvelle construction, etc.) ?',
        comment: null,
      },
      {
        question: 'Y a-t-il des projets en cours ? Des précisions sont requises pour savoir qui les achèvera.',
        comment: 'Si oui, nous aurions besoin de comprendre le nombre, l’échelle et le volume de ces projets. Y a-t-il un fournisseur existant qui achèvera ces projets ou y aura-t-il une rupture nette ?',
      },
      {
      ...
      {
        question: 'Existe-t-il un système de management de l’énergie (ISO 50001 / ISO 14001 / ISO 18001 / ISO 9001) en place?',
        comment: null,
      },
    ],
    'catering': [
      ...
      {
        question: 'Fournir la répartition moyenne des aliments vendus (frais, semi-préparés, emballés, ...) / types de menus (nombre de choix, entrées, desserts, ...) ou de régimes (allergènes, végétariens, ...)/ articles gratuits',
        comment: null,
      },
      {
        question: 'Existe-t-il une certification en matière de sécurité alimentaire (par ex. HACCP) ?',
        comment: null,
      },
      {
        question: 'Une reprise de personnel est-elle prévue ? (TUPE en pays européens)?',
        comment: '□ OUI   □ NON Si oui, pour qui cela s’applique-t-il?',
      },
      {
      ...
      {
        question: 'UNIFORMES : •Les uniformes sont-ils fournis actuellement ? •Et le lavage des uniformes ? •Equipemnt EPI',
        comment: null,
      },
      {
        question: 'ATTENTES DU CLIENT : Y a-t-il des pratiques exemplaires que vous aimez avec votre entrepreneur actuel ? Y a-t-il des améliorations qui pourraient être apportées ?',
      ...
      {
        question: 'DISTRIBUTEUR: • Leasing ? Si oui : • Montant du leasing par mois ? • Date de fin du contrat ? • S’agit-il d’un leasing en service complet ?',
        comment: 'Montant du leasing par mois?',
      },
    ],
    'uniforms': [
      {
    ...
    'security-system': [
      ...
      {
        question: 'A quelle heure les BARRIERES POUR VEHICULES sont-elles fermées ? Type de barrière pour véhicule (acier, manuelle, électronique, véhicule avec boucle d\'induction, barrière avec bras unique...)',
        comment: null,
      },
      {
        question: 'Y a-t-il des SORTIES PIÉTONNES ? Combien?',
        comment: null,
      },
      {
        question: 'Quels INCIDENTS ont eu lieu au cours des 2 dernières années sur le site (exemple: vol, intrusion) ?',
        comment: null,
      },
      {
        question: 'Détailler la SOW-SLA : - Option 1: Remplir l\'onglet SOW/SLA (avec les tâches et fréquences existantes) - Option 2: Détailler la SOW-SLA dans la case ci-dessous',
        comment: null,
      },
      {
        question: 'La sécurité est-elle gérée par un seul entrepreneur ou y en a-t-il plusieurs? Quel est le nom du/des sous-traitant(s)?',
        comment: null,
      },
      {
        question: 'SOW-SLA: Y a-t-il un besoin de patrouilles canines?',
        comment: null,
      },
      {
        question: 'SOW-SLA: Qu\'en est-il de la sécurité du toit du bâtiment?',
        comment: null,
      },
      {
        question: 'SOW-SLA: Y a-t-il des exigences de sécurité spécifiques pour une date ou une période de l\'année particulière (ex. jours fériés)?',
        comment: null,
      },
      {
        question: 'SOW-SLA: Y a-t-il des exigences de sécurité spécifiques pour des événements spéciaux? (ex. concerts, fêtes d\'entreprise)',
        comment: null,
      },
      {
        question: 'GESTION DES CLÉS: • Rôle des agents de sécurité: ex. nombre total de clés; Ont-ils les clés uniquement pour certains services?',
        comment: null,
      },
      {
        question: 'RONDES • Ronde quotidienne / horaires / durée / temps maximum entre 2 rondes • Nombre de rondes',
        comment: null,
      },
      {
        question: 'ALARMES • Types d\'alarmes? • Nombre d\'alarmes sur le site',
        comment: null,
      },
      {
        question: 'GESTION DES URGENCES ET INCIDENTS • Délai de traitement des alarmes • Niveau de gestion des incidents',
        comment: null,
      },
      {
        question: 'EQUIPEMENTS ET MATERIEL • Liste des équipements et matériel • Qui les achète / à qui appartiennent-ils / qui les utilise • Marque du/des matériel(s) - Qui gère la maintenance?',
        comment: null,
      },
      {
    ...
    'waste-management': [
      ...
      {
        question: 'TRI DES DECHETS 1. Le tri des déchets est-il réalisé ? quels sont les déchets triés? 2. Quels déchets non triés pourraient être triés ? Exemple: gobelets, canettes, piles, toners, DEEE, tubes fluorescents, coupes de nourriture, cartons, papiers, mobiliers, emballages? 4. Existe-t-il une reprise de déchets ? Si oui, à qui est versé le revenu correspondant ?',
        comment: '1. 2. [ ] OUI / [ ] NON Si oui, spécifier : 3. [ ] OUI / [ ] NON Si oui, à qui:',
      },
      {
        question: 'ZONE DE STOCKAGE DES DÉCHETS 1. Existe-t-il des zones de stockage des déchets spécifiques ? 2. Si oui, sont-elles centralisées ou décentralisées ? Sont-elles faciles d’accès et bien équipées ? 3. Y a-t-il un compacteur, broyeur, presse à balle sur site ? Sont-ils la propriété du client ou du prestataire ? Si oui, préciser leur coût, volume, fournisseur, déchets concernés ?',
        comment: '1. [ ] OUI / [ ] NON 2. [ ] OUI / [ ] NON description: 3. [ ] OUI / [ ] NON description: ',
      },
      {
        question: 'ÉVACUATION DES DÉCHETS 1. Qui est responsable de l’évacuation des déchets ? Client ou Prestataire ? 2. Indiquer la fréquence d’évacuation pour chaque type de déchets (ex. quotidien, hebdomadaire, mensuel, sur appel). 3. Indiquer le nom des prestataires d’évacuation des déchets.',
        comment: '1. [ ] CLIENT / [ ] PRESTATAIRE 2. 3. ',
      },
      {
        question: 'EQUIPEMENTS DE GESTION DES DECHETS 1. Existe-t-il des équipements de gestion des déchets sur site (ex. bennes, broyeur, compacteur, presse à balle, etc.). Si oui, préciser leur coût, volume, fournisseur, déchets concernés 3. État général du gros matériel (préciser pour chaque type de matériel) ? Qui est responsable de son entretien?',
    ...
    'grounds-eng': [
      ...
      {
        question: 'EVALUATION DES RISQUES •  Existe-t-il des risques spécifiques - Pentes, eau, travail en hauteur, risque de chutes, arbres dangereux, déneigement,  parcours santé ? SPECIFICITE DU SITE • Spécificités du site, c’est-à-dire zone inondable, froid extrême, neige...',
        comment: '[ ] OUI    [ ] NON Si oui, précisez',
      },
      {
        question: 'DEVELOPPEMENT DURABLE • Existe-t-il un plan de développement durable ?',
        comment: '[  ] OUI   [  ] NON Si oui, précisez',
      },
      {
        ...
        comment: '1) [  ] OUI     [  ] NON 2) [  ] OUI     [  ] NON - Liste des pesticides utilisés sur site - Existe-t-il des restrictions locales pour l\'utilisation des pesticides ?',
      },
      {
    ...
    'cleaning-mat-replacement': [
      ...
      {
        question: 'EQUIPEMENT ET MATERIEL: • Pouvez-vous obtenir la liste de tous les équipement et matériels? • Qui les achète / les détient / les utilise? • Quelles marques / références de produit?',
        comment: null,
      },
      {
        question: 'NETTOYAGE DE LA VITRERIE: Quelle est la surface de vitrerie à nettoyer : • The entrance hall? • Glass partitions (height/width of windows)? • Accessible interior glazing? • Accessible exterior glazing? Is the cleaning of inaccessible glass (interior/exterior) (outside of man\'s height) included in the perimeter? If so, specify the surface area and the means of elevation (pole, boom lift, spider, roof lift, light truck/HGV boom lift, etc.) necessary to carry out the service and who provides it (customer equipment, equipment to rent/buy). If it is mountaineering glazing, also specify the number of anchor points. / • Specify the number of sides of the glazing to be cleaned',
        comment: null,
      },
      {
      ...
      {
        question: 'Les mécanismes conventionnels de transfert de personnel s\'appliquent-t-il dans le cas présent? (Bill 7 en Ontario),',
        comment: null,
      },
      {
        question: 'Décrire \'ORGANISATION EN PLACE (nombre de chefs d\'équipes, nombre d\'employés à temps plein/partiel, équipes, horaires de travail, rapports, etc.). Combien de fois par jour les nettoyeurs interviennent-ils?',
        comment: null,
      },
    ],
    'fm-equipment-leasing': [
      {
        question: 'Liste des équipements ( Camion Foklift, transpalette, chariots motorisés, photocopieurs, nettoyeurs de sols,',
        comment: null
      },
      {
      ...
      {
        question: 'Quel est le budget d’entretien,',
        comment: null
      },
      {
        question: 'Copie des dernières factures,',
        comment: null
      }
    ]
  },
